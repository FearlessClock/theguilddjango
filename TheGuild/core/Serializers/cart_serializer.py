...
class CartSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cart
        fields = ['id', 'type', 'character', 'carried_items',  'location_type', 'location_id', 'current_x', 'current_y', 'target_x', 'target_y', 'travel_duration_seconds', 'departure_time', 'is_traveling']
