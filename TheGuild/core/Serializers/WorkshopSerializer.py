from TheGuild.core.Models.WorkshopModel import Workshop, Upgrade, Workshop_Recipe, Workshop_Storage
from TheGuild.core.Serializers.goods_serializer import ItemInformationSerializer, RecipeSerializer, RecipeWithGoodsSerializer
...
class WorkshopSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Workshop
        fields = ['id', 'character', 'building', 'carried_items', 'upgrade', 'tick', 'last_update']
